...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2024 at 03:07 AM
...
(10, 225, 1, '2024-01-12', '2024-01-19');
...
INSERT INTO `user_tb` (`user_id`, `fname`, `lname`, `email`, `phone`, `pass`, `type`) VALUES
(1, 'test', 'some', 'test@mail.com', '12345', 'pass', 'customer');
...
--
ALTER TABLE `book_tb`
  MODIFY `book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250;
